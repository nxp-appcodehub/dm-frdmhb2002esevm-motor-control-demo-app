...
gpioHandleKSDK_t DATA0 = {.base = GPIO2, .pinNumber = 6, .mask = 1 << (6), .clockName = kCLOCK_Gpio2, .portNumber = 2};
gpioHandleKSDK_t DATA1 = {.base = GPIO2, .pinNumber = 4, .mask = 1 << (4), .clockName = kCLOCK_Gpio2, .portNumber = 2};

gpioHandleKSDK_t CTRL0 = {.base = GPIO1, .pinNumber = 12, .mask = 1 << (12), .clockName = kCLOCK_Gpio1, .portNumber = 1};
gpioHandleKSDK_t CTRL1 = {.base = GPIO0, .pinNumber = 19, .mask = 1 << (19), .clockName = kCLOCK_Gpio0, .portNumber = 0};

gpioHandleKSDK_t FS_B = {.base = GPIO5, .pinNumber = 3, .mask = 1 << (3), .clockName = kCLOCK_None, .portNumber = 5};
