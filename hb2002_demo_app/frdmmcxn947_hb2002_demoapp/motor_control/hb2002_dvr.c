...
int32_t HB2002_InitPins(void)
{
	...
	/* Enables the clock for PORT1: Enables clock */
	    ...
	    CLOCK_AttachClk(kCLOCK_DivSlowClk);

	const port_pin_config_t port1_pin12_config = {/* Internal pull-up/down resistor is disabled */
													  kPORT_PullDisable,
													  /* Low internal pull resistor value is selected. */
													  kPORT_LowPullResistor,
													  /* Fast slew rate is configured */
													  ...
													  /* Pin Control Register fields [15:0] are not locked */
													  kPORT_UnlockRegister};
	/* PORT1_12 is configured as PORT1_12 */
	PORT_SetPinConfig(PORT1, 12U, &port1_pin12_config);

	const port_pin_config_t port0_pin19_config = {/* Internal pull-up/down resistor is disabled */
														  kPORT_PullDisable,
														  /* Low internal pull resistor value is selected. */
														  kPORT_LowPullResistor,
														  /* Fast slew rate is configured */
														  ...
														  kPORT_UnlockRegister};
	/* PORT1_12 is configured as PORT1_12 */
	PORT_SetPinConfig(PORT0, 19U, &port0_pin19_config);

	const port_pin_config_t port5_pin3_config = {/* Internal pull-up/down resistor is disabled */
															  kPORT_PullDisable,
															  /* Low internal pull resistor value is selected. */
															  kPORT_LowPullResistor,
															  /* Fast slew rate is configured */
															  ...
															  kPORT_UnlockRegister};
		/* PORT1_12 is configured as PORT1_12 */
		PORT_SetPinConfig(PORT5, 3U, &port5_pin3_config);

		const port_pin_config_t port0_22_pinU12_config = {/* Internal pull-up/down resistor is disabled */
															  kPORT_PullDisable,
															  /* Low internal pull resistor value is selected. */
															  kPORT_LowPullResistor,
															  /* Fast slew rate is configured */
															  ...
															  /* Pin Control Register fields [15:0] are not locked */
															  kPORT_UnlockRegister};
			/* PORT4_0 (pin U12) is configured as ADC0_A0 */
			PORT_SetPinConfig(PORT0, 22U, &port0_22_pinU12_config);
