...
gpioHandleKSDK_t DATA0 = {.base = GPIO3, .pinNumber = 6, .mask = 1 << (6), .clockName = kCLOCK_GateGPIO3, .portNumber = 3};
gpioHandleKSDK_t DATA1 = {.base = GPIO3, .pinNumber = 8, .mask = 1 << (8), .clockName = kCLOCK_GateGPIO3, .portNumber = 3};
...
gpioHandleKSDK_t FS_B = {.base = GPIO2, .pinNumber = 3, .mask = 1 << (3), .clockName = kCLOCK_GateGPIO2, .portNumber = 2};
